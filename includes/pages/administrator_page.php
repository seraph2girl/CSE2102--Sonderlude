      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="../options/users.php">View Users</a></li>
            <li><a href="../register_user.php">Insert User</a></li>
            <li><a href="../options/users.php">Endorse Reception Actions</a></li>
...
<center><h3><b>Administrator</b></h3></center>
</body>
