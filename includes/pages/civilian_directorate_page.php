...
<head>
    ...
    <title>Civilian Directorate</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><b>Option</b><span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="../options/database.php">View Database</a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="../../index.php"><?php echo htmlspecialchars($_SESSION["firstName"]); ?> <?php echo htmlspecialchars($_SESSION["lastName"]); ?> </a></li>
...
<center><h3><b>Civilian Directorate</b></h3></center>
</body>
