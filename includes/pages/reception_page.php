    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="../options/insert_inmates.php">Insert Inmate</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="../../index.php"><?php echo htmlspecialchars($_SESSION["firstName"]); ?> <?php echo htmlspecialchars($_SESSION["lastName"]); ?></b> </a></li>
...
<center><h3><b>Reception</b></h3></center>
</body>
